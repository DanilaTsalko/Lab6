    ...
    // не распахнуто на весь экран
        ...
        private JMenuItem pauseSomeMenuItem;
                ...
                public void actionPerformed(ActionEvent event) {
                    ...
                    if (!pauseMenuItem.isEnabled() &&
                            !resumeMenuItem.isEnabled()&&
                                !pauseSomeMenuItem.isEnabled()) {
    // Ни один из пунктов меню не являются
    // доступными - сделать доступным "Паузу"
                        pauseMenuItem.setEnabled(true);
                        pauseSomeMenuItem.setEnabled(true);
                    }
                }
            };
            ...
            Action pauseSomeAction = new AbstractAction("Приостановить движение некоторых"){
                public void actionPerformed(ActionEvent event) {
                    field.pauseSome();
                    pauseSomeMenuItem.setEnabled(false);
                    pauseMenuItem.setEnabled(true);
                    resumeMenuItem.setEnabled(true);
                }
            };
            pauseSomeMenuItem = controlMenu.add(pauseSomeAction);
            pauseSomeMenuItem.setEnabled(false);
